...
row_one = html.Div(
    dbc.Row([
        dbc.Col([html.H1("Paralympics Dashboard", className="text-center text-primary, mb-4"), html.P(
...
# Add a CSS class to make the header blue
app.css.append_css({"external_url": "https://your-website.com/css/style.css"})
